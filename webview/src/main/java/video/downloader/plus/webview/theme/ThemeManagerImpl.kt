...
import video.downloader.plus.webview.theme.DarkTheme
import video.downloader.plus.webview.theme.LightTheme
import video.downloader.plus.webview.theme.Theme
import video.downloader.plus.webview.theme.ThemeManager

internal class ThemeManagerImpl(private val sharedPreferences: SharedPreferences) : ThemeManager {
    ...
    override fun getTheme() = if (currentThemeIndex == 0) lightTheme else darkTheme
